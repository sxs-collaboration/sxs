...
catalog_file_description = """
        ...
        ellipsis ... indicates that the preceding structure can be repeated.

          {
              ...
              'records': {  # Includes *all* versions of *all* records published in the 'sxs' community, not just simulations
                  '<id>': {  # This ID key is the same as the 'id' value inside this object
    ...
    'simulation_versions': {  # Map SXS ID (e.g., SXS:BBH:1234 or SXS:BHNS:0001) to list of versions of the Zenodo record
                  '<sxs_id>': [
                      '<id0>',  # Zenodo ID of the "concept" record, which encompasses all versions
                      '<id1>',  # Zenodo ID of the oldest version; to get the newest, just index this list with [-1]
                      ...
                  ],
                  ...
              }
              '<sxs_id>': {  # The SXS ID is a string like SXS:BHNS:0001 or SXS:BBH:1234
                  ...
                  'versions': [
                      {  # Oldest version first (specifically, with respect to 'created' timestamp)
