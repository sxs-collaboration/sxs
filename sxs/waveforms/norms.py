...
def compute_L2_norm(wa, wb, t1=None, t2=None, modes=None, modes_for_norm=None, normalize=True):
    """Compute the L² norm between two waveforms over the
    ...
    normalize : bool, optional
        ...
        the unnormalized L² norm and what would have been the normalization.
        Default is True.

    Returns
    -------
    L2_norm: float
        L² norm between to the waveforms
...
def compute_mismatch(wa, wb, x1=None, x2=None, modes=None, ASD=None):
    ...
    Waveforms can either be WaveformModes objects in the time-domain
    or the frequency domain, in which case a mismatch over the two-sphere is computed,
    or TimeSeries objects, in which case the time series mismatch is computed.
