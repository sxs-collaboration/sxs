"""Sub-submodule to validate NSNS systems"""


def horizons(path, short_circuit=False, validity=None):
    """Validate Horizons.h5 file for NSNS simulation

    This function is here just for consistency; its input arguments are ignored, and it always
    returns True.
...
def waveforms(path, *args, short_circuit=False, validity=None, extrapolated=None):
    """Validate waveform files for NSNS simulation
