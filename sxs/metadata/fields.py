...
metadata_fields = [
    ...
    },
    {
        ...
        'title': r'$\Omega^{\mathrm{orb}\ \mathrm{ini}}$',
    ...
    },
    {
        ...
        'title': r'Mass ratio $M^1/M^2$',
        'tooltip': 'Ratio of masses at relaxation time $M^{\mathrm{rel}, 1} / M^{\mathrm{rel}, 2}$',
        'type': 'float',
        'visible': True,
    },
    {
    ...
    },
    {
        ...
        'title': r'$\Omega^{\mathrm{orb}\ \mathrm{rel}}$',
