...
metadata_field_mapping = {
    ...
    'relaxed_measurement_time': (r'$t_{\mathrm{rel}}$', 'Time at which "relaxed" quantities are measured'),
    'relaxed_mass1': (r'$M_{\mathrm{rel}, 1}$', 'Mass of object 1 after relaxation'),
    'relaxed_mass2': (r'$M_{\mathrm{rel}, 2}$', 'Mass of object 2 after relaxation'),
    'relaxed_dimensionless_spin1': (r'$\vec{chi}_{\mathrm{rel}, 1}$', 'Dimensionless spin of object 1 after relaxation'),
    'relaxed_dimensionless_spin2': (r'$\vec{chi}_{\mathrm{rel}, 2}$', 'Dimensionless spin of object 2 after relaxation'),
    'relaxed_position1': (r'$\vec{x}_{\mathrm{rel}, 1}$', 'Position of object 1 after relaxation'),
    'relaxed_position2': (r'$\vec{x}_{\mathrm{rel}, 2}$', 'Position of object 2 after relaxation'),
    'relaxed_orbital_frequency': (r'$\Omega_{\mathrm{orb}\ \mathrm{rel}}$', 'Orbital frequency after relaxation'),
    'relaxed_eccentricity': (r'$e_{\mathrm{rel}}$', 'Eccentricity after relaxation'),
    'relaxed_mean_anomaly': (r'$M_{\mathrm{rel}}$', 'Mean anomaly after relaxation'),
